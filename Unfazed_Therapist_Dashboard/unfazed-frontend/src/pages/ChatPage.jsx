...
export default function ChatPage() {
  ...
  async function endSession() {
    ...
    try {
      setEnding(true)
      await axiosInstance.post(`/scheduling/sessions/${sessionId}/end`)
      setEnded(true)
    } catch (requestError) {
  ...
  useEffect(() => {
    ...
    socket.on('connect', () => {
      setLoading(false)
      socket.emit('session:wait', sessionId)
    })
